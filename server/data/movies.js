import { AGE_RATING, CONTENT, SUBSCRIPTIONS } from "../../src/services/access.service";

export const moviesDb = [
  {
    id: "mision-delta",
    title: "Misión Delta",
    contentType: CONTENT.MOVIE,
    duration: "1h 42min",
    year: 2024,
    genre: "Suspenso",
    director: "Joaquín Ramírez, Nahuel Bande",
    rating: AGE_RATING.SAM_16,
    ...
    vimeoId: "1132062590",
    requiredSubscription: SUBSCRIPTIONS.STANDARD,
    rentalPrice: 4500,
    reviews: [
  ...
  },
  {
    ...
    vimeoId: "1204143719",
    requiredSubscription: SUBSCRIPTIONS.FREE,
    rentalPrice: null,
    reviews: []
  },
  { 
