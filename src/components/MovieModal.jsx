      ...
      {selectedMovie && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <button
              onClick={() => setSelectedMovie(null)}
              className="absolute top-4 right-4 p-2 bg-black/60 rounded-full text-white hover:text-[#9D0208] transition z-10"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="p-6 space-y-4">
              ...
              {/* INFO */}
              <div className="flex flex-wrap gap-3 text-xs text-[#8E8E8E]">
                <span className="px-2 py-0.5 bg-[#9D0208]/15 text-[#9D0208] font-bold rounded">
                  {selectedMovie.genre}
                </span>
              ...
              <div className="bg-[#050505] p-4 rounded-xl border border-[#212121] flex items-center justify-between">
                ...
                <div>
                  {unlockedMovies.includes(selectedMovie.id) || selectedMovie.price === 0 ? (
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] text-[#8E8E8E] uppercase">
                        Alquiler digital
                      </span>
                ...
                {unlockedMovies.includes(selectedMovie.id) || selectedMovie.price === 0 ? (
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-[#9D0208] hover:bg-[#b0030a] text-white rounded text-xs uppercase font-bold flex items-center gap-2"
                  >
